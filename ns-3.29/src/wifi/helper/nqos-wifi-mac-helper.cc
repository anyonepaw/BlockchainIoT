...
NqosWifiMacHelper NqosWifiMacHelper::Default(void) {
	...
	// attributes.
	helper.SetType("ns3::AdhocWifiMac", "QosSupported", BooleanValue(false));
	return helper;
}

void NqosWifiMacHelper::SetType(std::string type, std::string n0,
...
Ptr<WifiMac> NqosWifiMacHelper::Create(void) const {
