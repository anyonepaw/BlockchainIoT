...
//  Network Topology
//       VLAN1                            VLAN2
//    Wifi 10.1.3.0                    Wifi 10.1.3.0
//                  AP             AP
//    *    *    *    *             *    *    *    *
//    |    |    |    |             |    |    |    |
//    n5   n6   n7   n1     n2    n4   n6   n7   n0
//                    |      |     |
//                    ===============
//                      LAN 10.1.2.0
...
int main(int argc, char *argv[]) {
	...
	vlan1Nodes.Create(4);
	NodeContainer vlan1Ap = csmaNodes.Get(0);

	NodeContainer vlan2Nodes;
	vlan2Nodes.Create(4);
	NodeContainer vlan2Ap = csmaNodes.Get(2);
	...
	//Когда настройка PHY и MAC уровней завершены,
	//мы можем создать сетевые wi-fi устройства
	...
	mobility.Install(vlan1Nodes);
	mobility.Install(vlan2Nodes);

	mobility.SetMobilityModel("ns3::ConstantPositionMobilityModel");
	mobility.Install(vlan1Ap);
	mobility.Install(vlan2Ap);
	...
	ApplicationContainer clientApp2 = echoClient.Install(vlan2Nodes.Get(1));
	...
	phy1.EnablePcap("vlan1", vlan1Devices.Get(0));
	phy2.EnablePcap("vlan2", vlan2Devices.Get(0));
